...
COLLECTD_UNTESTED_PLUGINS="amqp apple_sensors barometer ceph drbd genericjmx ipvs lpar modbus
	tape write_kafka write_riemann write_sensu write_tsdb zfs_arc"
...
src_configure() {
	...
	use collectd_plugins_libvirt || myconf+=" --with-libvirt=no"

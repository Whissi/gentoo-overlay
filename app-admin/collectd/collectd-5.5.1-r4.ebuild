...
COMMON_DEPEND="
	...
	collectd_plugins_ascent?		( net-misc/curl dev-libs/libxml2:2= )
	collectd_plugins_bind?			( dev-libs/libxml2:2= )
	collectd_plugins_ceph?			( dev-libs/yajl:0= )
	collectd_plugins_curl?			( net-misc/curl )
	collectd_plugins_curl_json?		( net-misc/curl dev-libs/yajl:0= )
	collectd_plugins_curl_xml?		( net-misc/curl dev-libs/libxml2:2= )
	collectd_plugins_dbi?			( dev-db/libdbi )
	collectd_plugins_dns?			( net-libs/libpcap )
	collectd_plugins_gmond?			( sys-cluster/ganglia )
	collectd_plugins_ipmi?			( >=sys-libs/openipmi-2.0.16-r1 )
	collectd_plugins_iptables?		( >=net-firewall/iptables-1.4.13:0= )
	collectd_plugins_log_logstash?		( dev-libs/yajl:0= )
	...
	collectd_plugins_onewire?		( >=sys-fs/owfs-3.1:0= )
	...
	collectd_plugins_rrdcached?		( net-analyzer/rrdtool:0= )
	collectd_plugins_rrdtool?		( net-analyzer/rrdtool:0= )
	...
	collectd_plugins_virt?			( app-emulation/libvirt:0= dev-libs/libxml2:2= )
	collectd_plugins_write_http?		( net-misc/curl )
	collectd_plugins_write_kafka?		( >=dev-libs/librdkafka-0.9.0.99:0= )
	collectd_plugins_write_redis?		( dev-libs/hiredis )
	collectd_plugins_write_riemann?		( dev-libs/protobuf-c:0= )

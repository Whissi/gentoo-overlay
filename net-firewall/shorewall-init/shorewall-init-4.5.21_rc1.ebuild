...
src_prepare() {
	...
	epatch "${FILESDIR}"/${PVR}/install.sh-0001-Use-bin-true-instead-of-return-for-empty-if-block.patch
	epatch "${FILESDIR}"/${PVR}/shorewall-init_01-Remove-ipset-functionality.patch
	epatch_user
}

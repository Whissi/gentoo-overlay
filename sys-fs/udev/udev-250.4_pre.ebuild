...
# $Id: f6698bd8ca5fa567b1832368a8e4b24ee187cd70 $

EAPI=7
PYTHON_COMPAT=( python3_{8..10} )

inherit bash-completion-r1 flag-o-matic linux-info meson-multilib ninja-utils python-any-r1 toolchain-funcs udev usr-ldscript whissi_ebuilds
...
if [[ ${MY_PV} = 9999* ]] ; then
	...
	FIXUP_PATCH="${PN}-250.4-revert-systemd-messup.patch"

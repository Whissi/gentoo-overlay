...
HTTP_VHOST_TRAFFIC_STATUS_MODULE_PV="0.2.5"
...
IUSE="aio debug +http +http2 http3 +http-cache ktls libatomic rtmp selinux ssl test threads vim-syntax"
...
CDEPEND="
	...
	nginx_modules_http_rewrite? ( dev-libs/libpcre2:= )
...
REQUIRED_USE="ktls? ( ssl )
	...
	nginx_modules_http_naxsi? ( nginx_modules_http_rewrite )
